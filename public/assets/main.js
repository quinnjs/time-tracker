...
var BootstrapPage = React.createClass({displayName: 'BootstrapPage',
  render: function() {
    var styles = this.props.styles || CDN_BOOTSTRAP_CSS;
    return React.DOM.html(null, 
      React.DOM.head(null, 
        React.DOM.title(null, this.props.title), 
        React.DOM.link({rel: "stylesheet", href: styles})
      ), 
      React.DOM.body(null, 
        React.DOM.div({className: "container"}, 
          this.props.children
        ), 
        React.DOM.script({src: "/assets/main.js"})
      )
    );
  }
});
...
},{"moment":3,"react":147}],2:[function(require,module,exports){
...
},{"./views/track-page.jsx":1,"react":147}]},{},[148]);
